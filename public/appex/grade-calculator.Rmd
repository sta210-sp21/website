...
```{r}
#read in HW grades (out of 50 points)
hw01 <- 50
hw02 <- 50
hw03 <- 50
hw04 <- 50
...
```{r}
#read in lab grades (out of 50 points)
lab01 <- 50
lab02 <- 50
lab03 <- 50
lab04 <- 50
...
```{r}
#combine HW scores
hw <- tibble(hw01, hw02, hw03 , hw04, hw05) %>%
...
project_points <- sum(c(topic_ideas, proposal, peer_review, written_report, slides_video, reproducibility, video_comments, peer_teamwork))
