...
4. Part of the ANOVA table associated with this test is shown below. Use the information above to fill in the missing values, labeled A - H. Show how you calculate each value.
...
The coefficient for `parity` is different than in the linear model in Question 6. Briefly explain why there might be a difference. 
